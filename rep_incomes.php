	...
	<body>
		...
		<div id="menu_selection">
			<form action="rep_incomes.php" method="post">
				<input type="number" min="2006" max="2206" name="rep_year" style="width:200px; color: #000;" value="<?PHP if ($month == 01) echo $year-1; else echo $year; ?>" placeholder="Year" />
